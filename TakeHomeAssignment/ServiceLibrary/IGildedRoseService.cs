...
namespace GildedRose.ServiceLibrary
{
   ...
   public interface IGildedRoseService
   {
      ...
      /// <param name="itemId">The Guid of the item as a string.</param>
      /// <param name="quantity">The quantity.</param>
      /// <returns></returns>
      [OperationContract]
      [WebGet(UriTemplate = "BuyItem?token={token}&itemId={itemId}&quantity={quantity}", ResponseFormat = WebMessageFormat.Xml, BodyStyle = WebMessageBodyStyle.WrappedRequest)]
      RequestResponse BuyItem(string token, string itemId, int quantity);
